...
const SOCIAL_MEDIA_LINKS = [
    ...
    {
        name: 'linkdin',
        imgSrc: 'https://cdn-icons-png.flaticon.com/512/1384/1384053.png',
        href: '',
    },
]
                        ...
                        <Grid container direction='column' justifyContent='flex-end' spacing={2} sx={{ height: 120 }}>
                            <Grid item sx={{ display: 'flex' }}>
                                {SOCIAL_MEDIA_LINKS.map(link => {
                                    return (
                                        <Box component='a' href={link.href} sx={iconStyle} key={link.name}>
                                            <img src={link.imgSrc} alt={link.name} style={{ width: '100%' }} />
                                        </Box>
                                    )
                                })}
                            </Grid>
